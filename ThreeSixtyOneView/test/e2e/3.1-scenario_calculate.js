...
xdescribe("calculations", function(){
	...
	xit("should find the scenario in the items list", function(){
	...
	xit("should calculate a scenario", function(){
	...
	xit("should set the scenarios status to 'in process'", function(){
		browser.get(projectInfo.project.url);
	...
	xit("should click through to the calculate page when the scenario is 'in progress'", function(){
		browser.get(projectInfo.project.url);
	...
	xit("should disabled the 'simulate' button when a scenario is 'in progress'", function(){
		browser.get(projectInfo.calculate.url);
	...
	xit("should wait forever", function(){
		browser.get(projectInfo.calculate.url);
		browser.wait(function(){
			var deferred = protractor.promise.defer();
