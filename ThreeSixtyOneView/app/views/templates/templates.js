angular.module('ThreeSixtyOneView').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/directives/ms_dropdown.tpl.html',
    ...
    "\n" +
    "\t\t<span ng-click=\"select(selectedItem)\" data-ms-id=\"{{id}}\" class=\"status select\">{{selectedItem.label}}</span>&nbsp<span class=\"toggle\" ng-click=\"toggle()\"><icon type=\"caret-down\"></icon></span></h6> \r" +
    "\n" +
