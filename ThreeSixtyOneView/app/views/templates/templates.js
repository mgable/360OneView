angular.module('ThreeSixtyOneView').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/directives/display_actions.tpl.html',
    ...
    "\t<h4 class=\"pull-left title\">{{getSelectedLabel()}}&nbsp;<span>({{getCount()}})</span></h4>\n" +
    "\n" +
    "\t<h4 class=\"pull-left title\">{{SortAndFilterService.getSelectedLabel()}}&nbsp;<span>({{SortAndFilterService.getCount()}})</span><icon type=\"sort-desc\"></icon></h4>\n" +
    "\t<div class=\"filterDropdown\">\n" +
    "\t\t<span class=\"selected\">All Projects</span>\n" +
    "\t\t<span>Favorites</span>\n" +
    "\t\t<span>Created by Me</span>\n" +
    "\t\t<span>I Can Edit</span>\n" +
    "\t</div>\n" +
    "\n" +
    "\t<span>\n" +
