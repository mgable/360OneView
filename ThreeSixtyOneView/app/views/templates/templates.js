angular.module('ThreeSixtyOneView').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/modal/scenario_templates.tpl.html',
    ...
    "\n" +
    "\t<flipbook workflow={{CONFIG.view.ScenarioTemplates.workflow}} type=\"{{currentType.label}}\" template-url=\"views/directives/scenario_templates_navigation.tpl.html\" basePath=\"views/includes/scenario_templates\" submit-callback=\"submit\" cancel-callback=\"cancel\" enable-next=\"{{enableNext}}\">\r" +
    "\n" +
