angular.module('ThreeSixtyOneView').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/directives/ms_standard_dimension_card.tpl.html',
    ...
    "        <div class=\"parent-checkbox ms-checkbox no-select\">\n" +
    "            <label>\n" +
    "                <input type=\"checkbox\" ms-tristates-checkbox child-list=\"dimensionSchema.members\" property=\"isSelected\" ng-model=\"dimensionSchema.isSelected\"><i></i><span class=\"capitalized\">{{dimensionSchema.label}}</span>\n" +
    "            </label>\n" +
    "        </div>\n" +
    "        <div class=\"children-checkbox ms-checkbox no-select\" ng-repeat=\"item in dimensionSchema.members\" ng-if=\"templateType !== 'Action'\">\n" +
    "            <label>\n" +
