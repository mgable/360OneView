...
.constant('CONFIG', {
        "application": {
            ...
            "models": {
                ...
                "ScenarioModel": {
                    "responseTranslator": {"title": "name", "id": "id", "description": "description", "type":{"selector":"['predictionType']['type']"}, "createdBy":{"selector":"['auditInfo']['createdBy']['name']"}, "createdOn":{"selector":"['auditInfo']['createdOn']"}, "modifiedBy":{"selector":"['auditInfo']['lastUpdatedBy']['name']"}, "modifiedOn":{"selector":"['auditInfo']['lastUpdatedOn']"}}
                }
            }
        },
        "session": {
